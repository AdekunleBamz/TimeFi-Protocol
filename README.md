...
[![Documentation Status](https://img.shields.io/badge/docs-api-brightgreen?style=flat-square)](docs/API.md)
...
4. Run terminal as Administrator only when installing global packages
